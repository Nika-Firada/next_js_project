  ...
  return (
    <div className="prompt_card">
      <div className="flex justify-between items-start gap-5">
        <div className="flex-1 flex justify-start items-end gap-3 cursor-pointer">
          <Image 
          ...
          <div className="flex flex-col">
            ...
            <p className="font-inter text-sm text0gray-500">{post.creator.email}</p>
          </div>
        </div>
      ...
      <p onClick={() => handleTagClick && handleTagClick(post.tag)} className="cursor-pointer font-inter text-sm blue_gradient">#{post.tag}</p>
